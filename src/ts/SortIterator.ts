...
export class SortIterator<T extends IComparable> extends AbstractIterator<T> {
    ...
    constructor(comparables: Array<T> | AbstractIterator<T>) {
        ...
        this._comparables = compColl.slice().sort((a, b) => a.compareCriteria - b.compareCriteria);
        this.reset()
    }
